...
set secTag 3
set   L1 	        2.5            ; #length of the outer rectangle section
...
set secTag 4
set   L1 	        4.2            ; #length of the outer rectangle section
set   a	        0.06             ; #the cover thickness of the concrete
set epsy 	[expr $HRB400(2)/$HRB400(4)];   # steel yield strain 
set Ky 	[expr $epsy/(0.7*($L1-2*$a))]; 	  # Estimated yield curvature
...
set secTag 6
set   L1 	        4.256            ; #length of the outer rectangle section
set   a	        0.06             ; #the cover thickness of the concrete
set epsy 	[expr $HRB400(2)/$HRB400(4)];   # steel yield strain 
set Ky 	[expr $epsy/(0.7*($L1-2*$a))]; 	  # Estimated yield curvature
...
set secTag 7
set   L1 	        5.5            ; #length of the outer rectangle section
set   a	        0.06             ; #the cover thickness of the concrete
set epsy 	[expr $HRB400(2)/$HRB400(4)];   # steel yield strain 
set Ky 	[expr $epsy/(0.7*($L1-2*$a))]; 	  # Estimated yield curvature
}
...
# Create recorder
recorder Node -file MomentCurvature.txt -time -node 2 -dof 5 disp
...
pattern Plain 1 "Constant" {
	load 2 [expr -$axialLoad] 0.0 0.0 0.0 0.0 $moment
}
...
integrator DisplacementControl 2 5 $dK 
